...
Some applications and their synthetic versions (after fine tuning) are provided in [applications](./applications). You can also follow the instructions to run the applications.